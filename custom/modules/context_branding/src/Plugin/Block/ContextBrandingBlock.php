...
class ContextBrandingBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    // Use SVG variable instead of <$site_slogan = $site_config->get('slogan')>.
    $site_logo = '<svg id="site-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 52">
      <g id="and">
    ...
    $site_slogan = '<svg id="site-slogan" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 10.18">
        <path d="M9.21,9.93h-1.87l-.79-2.29h-3.86l-.79,2.29H0L3.53.33h2.28l3.44,9.6h-.04ZM4.61,1.95l-1.45,4.15h2.9l-1.45-4.15Z" />
        <path d="M22.03.33h1.78v9.72h-1.99l-4.61-7.06v6.98h-1.78V.37h2.03l4.56,7.02V.33Z" />
        <path d="M27.18,9.93V.33h6.56v1.58h-4.69v2.41h3.86v1.58h-3.86v2.45h4.69v1.58h-6.56Z" />
        <path d="M40.62,9.93h-1.91L36.06.33h1.99l1.66,7.31,1.99-7.31h2.16l2.03,7.31,1.66-7.31h1.91l-2.66,9.6h-1.95l-2.12-7.44-2.16,7.44h.04Z" />
        <path d="M63.48,7.19c0,1.58-.95,2.74-3.73,2.74h-3.73V.33h3.65c2.61,0,3.49,1.08,3.49,2.53,0,1.04-.62,1.7-1.74,2.08,1.24.29,2.03,1.08,2.03,2.24h.04ZM59.62,1.83h-1.78v2.62h1.62c1.2,0,1.83-.5,1.83-1.33s-.58-1.29-1.66-1.29ZM59.58,5.82h-1.7v2.62h1.87c1.24,0,1.87-.46,1.87-1.33,0-.96-.83-1.29-2.03-1.29Z" />
        <path d="M67.92,9.93h-1.87V.33s3.4,0,3.36,0c2.41,0,3.73,1.16,3.73,2.91,0,1.37-.79,2.33-2.07,2.78l2.53,3.91h-2.12l-2.12-3.53-1.37.08v3.45h-.08ZM69.33,4.99c1.16-.04,1.91-.58,1.91-1.62s-.75-1.5-2.07-1.5h-1.2v3.16h1.41l-.04-.04Z" />
        <path d="M79.99,10.18c-2.45,0-3.98-1.37-3.98-3.86V.33h1.87v5.73c0,1.58.71,2.49,2.2,2.49,1.33,0,2.07-.75,2.07-2.41,0,.04,0-5.82,0-5.82h1.87v5.82c0,2.62-1.45,4.03-4.02,4.03Z" />
        <path d="M93.65.33h1.78v9.72h-1.99l-4.61-7.06v6.98h-1.78V.37h2.03l4.56,7.02V.33Z" />
        <path d="M103.56,7.31c0-.79-.7-1.08-2.12-1.5-1.37-.37-2.99-1-2.99-2.91,0-1.7,1.33-2.87,3.44-2.87,1.33,0,2.36.33,3.32.83l-.46,1.58c-.83-.5-1.91-.83-2.82-.83-1.12,0-1.62.46-1.62,1.12,0,.79.87,1.08,2.2,1.45,1.45.42,2.95,1.08,2.95,2.91s-1.41,2.99-3.65,2.99c-1.29,0-2.53-.33-3.44-.87l.41-1.62c.87.54,1.91.91,3.07.91,1.04,0,1.78-.5,1.78-1.29l-.08.08Z" />
        <path d="M112.07,9.93h-1.91l-2.65-9.6h1.99l1.66,7.31,1.99-7.31h2.16l2.03,7.31,1.66-7.31h1.91l-2.66,9.6h-1.95l-2.12-7.44-2.16,7.44h.04Z" />
        <path d="M123.52,9.93V.33h1.87v9.6h-1.87Z" />
        <path d="M135.22,2.49c-.79-.5-1.62-.79-2.53-.79-1.87,0-3.11,1.29-3.11,3.37s1.2,3.45,3.15,3.45c1,0,1.91-.37,2.61-.87l.37,1.7c-.79.46-1.95.75-3.07.75-2.95,0-4.98-1.87-4.98-5.03s2.03-5.07,5.02-5.07c1.12,0,2.28.29,3.11.75l-.58,1.62v.12Z" />
        <path d="M140.45,4.74l3.61-4.4h2.24l-4.11,4.74,4.19,4.9h-2.28l-3.61-4.4v4.4h-1.87V.37h1.87v4.4l-.04-.04Z" />
        <path d="M160.07,7.19c0,1.58-.95,2.74-3.73,2.74h-3.74V.33h3.65c2.61,0,3.49,1.08,3.49,2.53,0,1.04-.62,1.7-1.74,2.08,1.24.29,2.03,1.08,2.03,2.24h.04ZM156.21,1.83h-1.78v2.62h1.62c1.2,0,1.83-.5,1.83-1.33s-.58-1.29-1.66-1.29ZM156.17,5.82h-1.7v2.62h1.87c1.24,0,1.87-.46,1.87-1.33,0-.96-.83-1.29-2.03-1.29Z" />
        <path d="M162.98,9.93V.33h1.87v9.6h-1.87Z" />
        <path d="M175.71,7.19c0,1.58-.95,2.74-3.73,2.74h-3.73V.33h3.65c2.61,0,3.49,1.08,3.49,2.53,0,1.04-.62,1.7-1.74,2.08,1.24.29,2.03,1.08,2.03,2.24h.04ZM171.86,1.83h-1.78v2.62h1.62c1.2,0,1.83-.5,1.83-1.33s-.58-1.29-1.66-1.29ZM171.82,5.82h-1.7v2.62h1.87c1.24,0,1.87-.46,1.87-1.33,0-.96-.83-1.29-2.03-1.29Z" />
        <path d="M178.58,9.93V.33h1.87v7.98h4.31v1.66h-6.22l.04-.04Z" />
        <path d="M187.37,9.93V.33h1.87v9.6h-1.87Z" />
        <path d="M197.12,10.18c-2.86,0-4.94-1.87-4.94-5.03,0-2.99,2.12-5.07,4.94-5.07s4.94,1.83,4.94,4.99c0,2.99-2.07,5.07-4.94,5.07v.04ZM197.08,1.66c-1.82,0-3.03,1.37-3.03,3.45s1.2,3.53,3.07,3.53,3.03-1.41,3.03-3.45-1.2-3.49-3.07-3.49v-.04Z" />
        <path d="M209.49,10.18c-2.95,0-4.98-1.91-4.98-5.03S206.54.08,209.53.08c1.16,0,2.53.29,3.4.83l-.58,1.62c-.83-.54-1.83-.83-2.78-.83-1.91,0-3.15,1.29-3.15,3.37s1.2,3.49,3.15,3.49c.66,0,1.33-.17,1.82-.37v-1.87h-2.53v-1.58h4.27v4.49c-1.04.58-2.37.91-3.61.91l-.04.04Z" />
        <path d="M218.16,9.93h-1.87V.33s3.4,0,3.36,0c2.41,0,3.73,1.16,3.73,2.91,0,1.37-.79,2.33-2.07,2.78l2.53,3.91h-2.12l-2.12-3.53-1.37.08v3.45h-.08ZM219.53,4.99c1.16-.04,1.91-.58,1.91-1.62s-.75-1.5-2.07-1.5h-1.2v3.16h1.41l-.04-.04Z" />
        <path d="M234.63,9.93h-1.87l-.79-2.29h-3.86l-.79,2.29h-1.91l3.53-9.6h2.28l3.44,9.6h-.04ZM230.03,1.95l-1.45,4.15h2.9l-1.45-4.15Z" />
        <path d="M239.99,6.94h-1.08v2.99h-1.87V.33h3.11c2.65,0,3.98,1.33,3.98,3.2,0,2.2-1.54,3.41-4.11,3.41h-.04ZM239.99,1.91h-1.12v3.49h1.2c1.41-.04,2.16-.66,2.16-1.79s-.75-1.7-2.2-1.7h-.04Z" />
        <path d="M253.14,9.93v-4.03h-4.56v4.03h-1.87V.33h1.87v3.95h4.56V.33h1.87v9.6h-1.87Z" />
        <path d="M262.64,6.23v3.74h-1.87v-3.74l-3.36-5.86h2.03l2.28,4.15,2.24-4.15h2.03l-3.32,5.9-.04-.04Z" />
      </svg>';

    if ($is_front) {
      // Supply unlinked heading level one for front page.
      $site_branding =
        '<h1 class="site-title"><span class="visually-hidden">' . $site_name . '</span>' . $site_logo .
        '</h1><div class="site-slogan">' . $site_slogan . '</div>';
    }
    else {
      $site_branding =
        '<a href="/" title="Home" rel="home" class="site-title">' . $site_logo .
        '</a><a href="/" class="site-slogan" tabindex="-1" title="Home" rel="home">' . $site_slogan . '</a>';
    }

    $markup = '
      <div class="contextual-region block block-system block-system-branding-block">
        <div class="navbar-brand d-flex align-items-center">
          <div>' . $site_branding . '</div>
        </div>
      </div>
    ';
