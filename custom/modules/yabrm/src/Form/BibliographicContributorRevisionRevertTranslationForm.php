...
class BibliographicContributorRevisionRevertTranslationForm extends BibliographicContributorRevisionRevertForm {
  ...
  public function getFormId() {
    return 'yabrm_contributor_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $yabrm_contributor_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $yabrm_contributor_revision);
  ...
  protected function prepareRevertedRevision(BibliographicContributorInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\yabrm\Entity\BibliographicContributorInterface $default_revision */
    $latest_revision = $this->bibliographicContributorStorage->load($revision->id());
