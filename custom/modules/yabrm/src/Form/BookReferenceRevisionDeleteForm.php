...
class BookReferenceRevisionDeleteForm extends ConfirmFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Revision from %revision-date of Book reference %title has been deleted.', [
    ...
    if ($this->connection->query('SELECT COUNT(DISTINCT vid) FROM {yabrm_book_revision} WHERE id = :id', [':id' => $this->revision->id()])->fetchField() > 1) {
      $form_state->setRedirect(
