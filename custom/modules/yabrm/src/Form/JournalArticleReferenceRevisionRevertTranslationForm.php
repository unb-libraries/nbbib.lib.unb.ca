 ...
 * @ingroup yabrm
 */
class JournalArticleReferenceRevisionRevertTranslationForm extends JournalArticleReferenceRevisionRevertForm {
  ...
  public function getFormId() {
    return 'yabrm_journal_article_revision_revert_translation_confirm';
  }
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $yabrm_journal_article_revision = NULL, $langcode = NULL) {
    $this->langcode = $langcode;
    $form = parent::buildForm($form, $form_state, $yabrm_journal_article_revision);
  ...
  protected function prepareRevertedRevision(JournalArticleReferenceInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\yabrm\Entity\JournalArticleReferenceInterface $default_revision */
    $latest_revision = $this->journalArticleReferenceStorage->load($revision->id());
