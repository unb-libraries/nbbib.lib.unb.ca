...
/**
 * Provides a form for reverting a Website reference revision.
 *
 * @ingroup yabrm
 */
class WebsiteReferenceRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new WebsiteReferenceRevisionRevertForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('entity_type.manager')->getStorage('yabrm_website'),
  ...
  public function getFormId() {
    return 'yabrm_website_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Website reference: reverted %title revision %revision.', [
      '%title' => $this->revision->label(),
      '%revision' => $this->revision->getRevisionId(),
    ]);
    $this->messenger()->addMessage($this->t('Website reference %title has been reverted to the revision from %revision-date.', [
      '%title' => $this->revision->label(),
   ...
   *
   * @param \Drupal\yabrm\Entity\WebsiteReferenceInterface $revision
   ...
   */
  protected function prepareRevertedRevision(WebsiteReferenceInterface $revision, FormStateInterface $form_state) {
